-- ========================================
-- 🔧 FIX: Fonction calculate_distance corrigée
-- ========================================
...
-- Créer la fonction avec le bon type de retour
...
-- ========================================
-- 🔄 Recréer les fonctions qui dépendent de calculate_distance
-- ========================================

-- Fonction: find_nearby_missions (corrigée)
...
BEGIN
  -- Get artisan's category and intervention radius from artisans table
  SELECT a.category, COALESCE(a.intervention_radius, 50)
  INTO v_category, v_intervention_radius
  FROM artisans a
  WHERE a.id = p_artisan_id;
  
  -- If artisan not found, try to get from users table
...
RAISE NOTICE '✅ Fonction calculate_distance et find_nearby_missions créées avec succès';
