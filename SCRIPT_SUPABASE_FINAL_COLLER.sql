-- ========================================
-- ARTISAN CONNECT - SCRIPT FINAL POUR NOUVELLE INSTANCE SUPABASE
-- Instance: nkxucjhavjfsogzpitry.supabase.co
-- Date: 2025-01-30
-- ========================================
...
-- Créer un utilisateur test client (email: client@test.com, password: Test123!)
-- Créer un utilisateur test artisan (email: artisan@test.com, password: Test123!)
-- Ces utilisateurs seront créés automatiquement lors de l'inscription via l'app
...
BEGIN
  ...
  RAISE NOTICE '1. Redémarrez votre serveur Expo (Ctrl+C puis "bun start")';
  RAISE NOTICE '2. Testez l inscription avec email: test@example.com';
  RAISE NOTICE '3. Vérifiez la connexion';
  RAISE NOTICE '';
  RAISE NOTICE '🔑 Vos clés Supabase sont déjà configurées dans .env';
  RAISE NOTICE '   URL: https://nkxucjhavjfsogzpitry.supabase.co';
END$$;
